...
class WorldTests(TestCase):
    def test_trifecta(self):
        ...
        eq_(list(w.do([e1, e2, e3, e4, e5, e6])), [[e1, timeout1, e2, e3, timeout2]]) # e1 and e2 are fine. e3 should go by quietly. e4 should cause a timeout of clicker at 10:1 and a timeout of built_in at 10:2.
